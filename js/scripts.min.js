...
//         link.rel = 'import';
//         link.href = item.getAttribute('import');
//         item.appendChild(link);
//         let promise = new Promise((resolve, reject) => {
//             link.onload = function (event) {
//                 let doc = this.import;
//                 var text = doc.querySelector('body').firstChild;
//                 item.innerHTML = '';
...
//                 case '/portfolio.html':
//                     document.getElementById('id_3').classList.add('selected');
//                     break;
//                 case '/index.html':
//                     document.getElementById('id_1').classList.add('selected');

//                     break;

//                 case '/pricing.html':
//                     document.getElementById('id_2').classList.add('selected');
...
// })
 ...
 jQuery(document).ready(function ($) {
     ...
     $('.contact-us,.burger2, .overlay2').click(function () {
